...
::: {.absolute bottom=25 left=100 width=150}
...
- I have an open-door policy - drop by any time my door is open to discuss class or not-class topics
   ...
   - But email/schedule if you want to guarantee time (outside OH): <https://calendly.com/mary-m-ryan/>
...
- Biweekly homeworks assigned Tuesdays at end of class, due on due-date at beginning of class
...
- Intermediate milestone assignments (10% / 45%)

- 8-10 minute oral presentation (10% / 45%)

- Final written report (25% / 45%)
...
- [Survival Analysis: A Self-Learning Text]{.alert}. 2016. Moore, DF. Springer International Publishing: Switzerland. ISBN: 9783319312439
:::
...
- [Applied Survival Analysis Using R]{.alert}. 2012. Kleinbaum DG and Klein M. Springer Science+Business Media: New York. ISBN: 9781441966452
:::
::::
...
- Guarantees everyone with some continuing level of informal brainstorming/feedback/support through the semester

   - We'll periodically meet in peer groups throughout the semester to work on (individual) final projects
...
- This is different than assuming observations are no independent
