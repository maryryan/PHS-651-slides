...
![*Tina and Penny say sorry for going too quickly last class*](tina-penny.jpeg)
:::
...
- Matrix algebra/course pacing anxiety
...
-   This stems from one of our OLS regression assumptions: that the *outcome values* for 2 observations will be [independent]{.underline}
...
Note that we usually think of clustering as something [different]{.alert} than a regular covariate
...
There are times when the distinction between "cluster" and "covariate/predictor" may a little fuzzy
