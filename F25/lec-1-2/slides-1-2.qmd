...
- This boundary can sometimes be fuzzy! See Clark & Linzer (2014) or McNeish & Kelley (2019) for more discussion
...
![Figure via Lesa Hoffman's F23 PSQF 6272 lecture slides: <https://www.lesahoffman.com/PSQF6272/PSQF6272_Lecture2_Empty_Level2Pred.pdf> -- link may be broken as Lesa is updating her slides](hoffman-cluster-means.png)
...
- LME $\beta_1$: `r round(summary(radon_lme)$coef[2,1],4)`
   ...
   - 95% CI (standard normal Z): (`r round(radon_lme_ci[4,1], 4)`, `r round(radon_lme_ci[4,2], 4)`)
