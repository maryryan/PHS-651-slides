...
Slides found at: <https://maryryan.github.io/PHS-651-slides/F25/lec-1/slides-1>
...
- Outcomes are [independent]{.alert} if we can identify and adjust for all the covariates that would drive correlations between outcome observations to 0

- Outcomes are [clustered/correlated]{.alert} if, for some reason or another, we *can't* identify or adjust for all the necessary covariates
