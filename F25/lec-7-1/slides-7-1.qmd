...
- $\widehat\beta_2 + \widehat\beta_9 =$ `r round(summary(exercise_gee)$coefficients[2,1],3)` + `r round(summary(exercise_gee)$coefficients[9,1],3)` = `r round(summary(exercise_gee)$coefficients[2,1] + summary(exercise_gee)$coefficients[9,1],3)`
