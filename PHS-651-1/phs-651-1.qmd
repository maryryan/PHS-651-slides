...
- [Independent data]{.underline}: data where each observation of a variable are not correlated with other observations of the same variable
...
- Natural group membership
   ...
   - e.g., Household members, city residents, classroom students
