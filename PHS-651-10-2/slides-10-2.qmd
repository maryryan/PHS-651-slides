...
Using this data, how would we estimate $S(t)$ at t=1 and t=2?
...
[$P(T>1) = \frac{\text{# alive at 1 year}}{\text{# "at risk"}} = 8/10=0.8$]{.fragment}

::: {.fragment}
What about $P(T>2)$?

- Do we use the "full" sample and look at $\frac{\text{# alive at 2 year}}{\text{# "at risk" since time 0}}$?

- Or do we use a "reduced" sample that only looks at $\frac{\text{# alive past 2 year}}{\text{# with complete data at 2 years}}$?
:::
...
::: {.column width="50%"}
We could use conditional probability!
