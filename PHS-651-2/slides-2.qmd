...
paste0( "(",round(summary(radon_lme)$coef[2,1] - sqrt(var_sand[2,2])*qnorm(0.975), 4), ", "
        , round(summary(radon_lme)$coef[2,1] + sqrt(var_sand[2,2])*qnorm(0.975), 4),")")
```
...
- LME $\beta_1$: `r round(summary(radon_lme)$coef[2,1],4)`
   ...
   - Robust 95% CI: (`r round(summary(radon_lme)$coef[2,1] - sqrt(var_sand[2,2])*qnorm(0.975), 4)`, `r round(summary(radon_lme)$coef[2,1] + sqrt(var_sand[2,2])*qnorm(0.975), 4)`)
:::
:::
...
ci_robust <- rbind(c(1,round(summary(radon_lme)$coef[2,1] - sqrt(var_sand[2,2])*qnorm(0.975), 4)), c(1,round(summary(radon_lme)$coef[2,1] + sqrt(var_sand[2,2])*qnorm(0.975), 4)))
