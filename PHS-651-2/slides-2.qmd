...
- Ran into issues around # parameters increaseing with data size
...
::: {.fragment}
![](clustering-SE-meme){.absolute top=150 right=75 width="20%"}
:::
...
What would the output/estiamtes of this model look like?
...
::: {.fragment}
![](clustering-SE-meme){.absolute top=50 right=200 width="20%"}
:::
...
plot(NA, xlim=c(-0.8,-0.45), ylim=c(0.5,2.2), xlab="", ylab="", yaxt='n', cex.axis=1.5)
...
text(ci_lme[2,2]+0.07, 1.5, "LME model-based CI", col="purple", cex=1.5)
segments(ci_robust[1,2], ci_robust[1,1],ci_robust[2,2], ci_robust[2,1], col="blue", lwd=2)
text(ci_robust[2,2]+0.05, 1, "LME robust CI", col="blue", cex=1.5)
```
:::
:::
