...
-   These are the ones we're (usually) most interested in in public and
    population health!
...
-   We get these in LMEs via distribution assumptions

-   What if we could [empirically estimate]{.alert} the covariance
...
1.  $E[Y_{ij}|\boldsymbol{X}_i] = \mu_{ij} = \beta_0 + W_{ij}\beta_1$
