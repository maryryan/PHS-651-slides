...
- The random effects in LMEs only *induce* a covariance structure (Fitzmaurice pg 474)
...
- What if we used the GLM estimating equation?
...
- Difference here: $v_i$ is the [working covariance]{.alert} for the outcome
   ...
   - Explicitly accounts for models of outcome variance *and* within-cluster association (components 2 and 3)
   
   - With GLMMs, our random effects were getting stuck in with $\mu_{ij}(\cdot)$ and the covariance structure was induced as a side product
